...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public PostAdapter(Context mContext, ArrayList<PostModel> mPost) {
                    ...
                    switch (item.getEmoticoned()) { // 기존 이모티콘 상태
                        ...
                        default : {
                            switch(item.getEmoticoned()) {
                                case 3 : { surprise.setChecked(false); item.setSurprise(item.getSurprise()-1); num_surprise.setText(String.valueOf(item.getSurprise())); break; }
                                case 2 : { angry.setChecked(false); item.setAngry(item.getAngry()-1); num_angry.setText(String.valueOf(item.getAngry())); break; }
                                case 1 : { sad.setChecked(false); item.setSad(item.getSad()-1); num_sad.setText(String.valueOf(item.getSad())); break; }
                            }
            ...
            surprise.setOnClickListener(new CheckBox.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (item.getEmoticoned()) { // 기존 이모티콘 상태
                        ...
                        default : {
                            switch(item.getEmoticoned()) {
                                case 4 : { love.setChecked(false); item.setLove(item.getLove()-1); num_love.setText(String.valueOf(item.getLove())); break; }
                                case 2 : { angry.setChecked(false); item.setAngry(item.getAngry()-1); num_angry.setText(String.valueOf(item.getAngry())); break; }
                                case 1 : { sad.setChecked(false); item.setSad(item.getSad()-1); num_sad.setText(String.valueOf(item.getSad())); break; }
                            }
...
//            try {
//                userid.setText(postModel.getUserid());
//                username.setText(postModel.getUsername());
//                origin.setText(postModel.getOrigin());
//                origin_writer.setText(postModel.getOrigin_writer());
//                postdate.setText(postModel.getPostdate());
//                description.setText(postModel.getDescription());
//
//                //              Glide.with(itemView).load(imgURL).into(post_image);
//            }catch (NullPointerException e){
//                e.printStackTrace();
//            }
//
//        }
    ...
    /// public void onRadioButtonClicked(View view) 고민 중인 위치
