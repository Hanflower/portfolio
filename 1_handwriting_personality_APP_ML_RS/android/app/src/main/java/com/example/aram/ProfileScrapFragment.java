...
public class ProfileScrapFragment extends Fragment {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    // 액티비티 이동
                    Intent intent = new Intent(getActivity(), ProfileScrapActivity.class);
    ...
    public void getPostData() {
        ...
        ProfileScrapRequest profileScrapRequest = new ProfileScrapRequest(userID, responseListener);
