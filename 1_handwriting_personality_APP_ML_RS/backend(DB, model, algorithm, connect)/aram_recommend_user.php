<?php
	...
	// echo "</pre>";
	if(empty($user_character) || empty($post_bookmark))
	{
		include('aram_recommend_contentbased.php');			
	}
	else
	{
		...
		$command = "C:\Users\Administrator\AppData\Local\Programs\Python\Python312\python.exe py_script\aram_recommend_user.py {$json_data} 2>&1";
		$output = array();
		exec($command, $output);
