<?php
	...
	$command = "C:\Users\Administrator\AppData\Local\Programs\Python\Python312\python.exe py_script\aram_recommend_contentbased.py {$userID} {$recent_contentID} {$interest_typeList}";
	$output = array();
	exec($command, $output);
